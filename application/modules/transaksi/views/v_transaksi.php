...
<article class="my-3" id="tables">
              ...
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  ...
                  <a class="btn btn-danger btn-rounded"
                    href="<?php echo base_url('transaksi/hapusTransaksi/'. $res->id_transaksi) ?>">Hapus Data!!</a>
                </div>
              </div>
            </div>
          </div>

          <?php echo form_open_multipart('transaksi/simpanLaporan');?>
  ...
  <?php echo form_open_multipart('transaksi/simpanTransaksi');?>
